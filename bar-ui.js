      ...
      var sound = soundManager.createSound({
        ...
        onplay: function() {
          ...
          callback('play', this);
            ...
            // Ubah title bar sesuai nama suratnya
            var tabTitle = $('.sm2-inline-status .sm2-playlist .sm2-playlist-target ul li').text();
...
if ('mediaSession' in navigator) {
  ...
  navigator.mediaSession.metadata = new MediaMetadata({
    title: tabTitle,
    artist: 'www.mushaf.id',
    album: 'Al Quran Online MP3',
    artwork: [
      { src: 'https://www.mushaf.id/sources/img/playlistartwork/96x96.png',   sizes: '96x96',   type: 'image/png' },
      { src: 'https://www.mushaf.id/sources/img/playlistartwork/128x128.png', sizes: '128x128', type: 'image/png' },
      { src: 'https://www.mushaf.id/sources/img/playlistartwork/192x192.png', sizes: '192x192', type: 'image/png' },
      { src: 'https://www.mushaf.id/sources/img/playlistartwork/256x256.png', sizes: '256x256', type: 'image/png' },
      { src: 'https://www.mushaf.id/sources/img/playlistartwork/384x384.png', sizes: '384x384', type: 'image/png' },
      { src: 'https://www.mushaf.id/sources/img/playlistartwork/512x512.png', sizes: '512x512', type: 'image/png' },
    ]
  });
  

  navigator.mediaSession.setActionHandler('play', callback('play', this));
  navigator.mediaSession.setActionHandler('pause', callback('pause', this));
  ...
  //navigator.mediaSession.setActionHandler('nexttrack', function() {});
        ...
        onfinish: function() {
          ...
          if (item && (playlistController.data.selectedIndex !== lastIndex || (playlistController.data.playlist.length === 1 && playlistController.data.loopMode))) {
            ...
            // Ubah title bar sesuai nama suratnya
            document.title = $('.sm2-inline-status .sm2-playlist .sm2-playlist-target ul li').text();
